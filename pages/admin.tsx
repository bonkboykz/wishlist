...
import { useCreateLinkMutation } from '@wishlist-graphql/generated-types';

const Admin = () => {
  const [createLink, { data, loading, error }] = useCreateLinkMutation();
  ...
  const onSubmit = async (data) => {
    ...
    const imageUrl = `https://yesset-main-test-bucket.website.yandexcloud.net/${image[0].name}`;
